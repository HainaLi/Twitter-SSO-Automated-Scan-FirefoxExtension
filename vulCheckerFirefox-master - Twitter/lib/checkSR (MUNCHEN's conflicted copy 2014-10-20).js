...
var nextModule = function (success){
	console.log("checkSR: nextModule"); 
...
var levenshteinDistance = function(a, b){
	console.log("checkSR: levenshteinDistance"); 
...
var RequestRecord = function(){
	console.log("checkSR: RequestRecordnup"); 
...
var ResponseRecord = function(){
	console.log("checkSR: ResponseRecord"); 
...
{
	console.log("checkSR: verifyThreat"); 
...
{
	console.log("checkSR: checkAgainstFilter"); 
...
function checkLoginButtonRemoved(exists){
	console.log("checkSR: checkLoginButtonRemoved"); 
...
function checkStructuralDiff(){
	console.log("checkSR: checkStructuralDiff"); 
...
{
	console.log("checkSR: processBuffer"); 
...
{
	console.log("checkSR: delayRefreshTestTab"); 
...
{
	console.log("checkSR: shouldClickLoginButton"); 
...
exports.shouldReturnLoginButtonInfoToVulChecker = function(){
	console.log("checkSR: shouldReturnLoginButtonInfoToVulChecker"); 
...
{
	//console.log("checkSR: shouldAutomateSSO"); 
...
{
	console.log("checkSR: processLoaded"); 
